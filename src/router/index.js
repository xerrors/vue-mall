...
{
  path: '/forgotpwd',
  component: () => import('@/views/account/ForgotPwd.vue')
},
{
  path: '/register',
...
{
  path: '/settlein',
  component: () => import('@/views/account/SettleIn.vue')
},
...
// * 仅商户可见
{
  ...
  path: '/user/:id',
  component: () => import('@/views/merchant/User.vue'),
  meta: {
    roles: ['merchant']
  }
},
...
{
  path: '/product/:id',
  component: () => import('@/views/common/Product.vue')
},
